...
GRANT SELECT ON TABLE tipo_accion TO usrconsulta;
...
CREATE USER usraccion PASSWORD '4cci0n';
GRANT INSERT, UPDATE, DELETE, SELECT ON TABLE accion_empleado TO usraccion;
GRANT SELECT ON TABLE empleado TO usraccion;
GRANT SELECT ON TABLE empresa TO usraccion;
GRANT SELECT ON TABLE empleado_empresa TO usraccion;
GRANT SELECT ON TABLE usuario TO usraccion;
GRANT SELECT ON TABLE sesion TO usraccion;
GRANT ALL ON accion_empleado_id_accion_seq to usraccion;
GRANT EXECUTE ON  FUNCTION crear_accion(token_sesion varchar(200), mensaje text, tipo smallint, sistemaparametro smallint, vendedor varchar(20)) TO usraccion;
GRANT EXECUTE ON FUNCTION obtenerUsuario(token_sesion varchar(200), sistema_parametro smallint) TO usraccion;